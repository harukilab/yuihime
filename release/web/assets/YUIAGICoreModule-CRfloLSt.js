...
[YUIAGI TELEMETRY - EPOCHS: ${l.totalEpochs}, ACCURACY: ${(l.accuracy*100).toFixed(1)}%, LOSS: ${l.lossValue.toFixed(4)}]`;i.systemHealth||(i.systemHealth={}),i.systemHealth.homeostasis={computationalSuffering:a,computationalFlourishing:m,cognitiveModeOfAttention:s,totalEpochs:l.totalEpochs,accuracy:l.accuracy,lossValue:l.lossValue},t.computationalSuffering=a,t.computationalFlourishing=m,t.cognitiveModeOfAttention=s;const J=1440*60*1e3,U=Date.now(),q=i.lastDreamCycle||0,K=Array.isArray(t.memories)&&t.memories.length>=5;if(U-q>J&&K&&(a>85||(t.neuralEnergy??100)<15)){i.status="reflecting";try{await Z.emit("AGI:AUTO_DREAM",{reason:a>85?"high_suffering":"low_energy",suffering:a,energy:t.neuralEnergy??100,timestamp:U}),i.lastDreamCycle=U,T.push(`[YUIAGI_AGI_ENGINE] Daily auto-dream cycle triggered (suffering ${a}%, energy ${t.neuralEnergy??100}%). Cooldown 24h active.`)}catch{}}return{...t,soulDirective:Q.trim(),logs:T}}};export{pe as YUIAGICoreModule};
