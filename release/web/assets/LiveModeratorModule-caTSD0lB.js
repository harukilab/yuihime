import{a as m,S as y}from"./index-BGrh6Zsf.js";class v{static async moderateChatBatch(e,g){if(!e||e.length===0)return{selectedMessage:null,contextSummary:"",action:"stay",reasoning:"No messages to process."};const h=await m.getAIConfig(),f=y.getModule("provider-selector");if(!f)return{selectedMessage:e[e.length-1],contextSummary:"Chat is moving rapidly.",action:"stay",reasoning:"AI Provider Selector missing."};const p=`You are the Live Chat Moderator for AI VTuber Yuihime. 
