const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CTrQ0wEq.js","assets/index-DAeTsvk2.css"])))=>i.map(i=>d[i]);
import{M as Ye,b as R,_,a as D,p as Te,P as He,o as _e}from"./index-CTrQ0wEq.js";var T={};function Ie(f){return f?f==="~"?_e.homedir():f.startsWith("~/")||f.startsWith("~\\")?Te.join(_e.homedir(),f.slice(2)):f:""}let E="",S="",N="",Ee=!1;const c=He.getInstance();function F(f){if(!f||typeof f!="string")return"Yui Airi";const n=f.trim(),e=n.match(/^#\s+(.+?)\s+Character\s+Profile$/im);if(e)return e[1].trim();const r=n.match(/\*\*Name\*\*:\s*(.+)/i);return r?r[1].trim():"Yui Airi"}async function je(){if(Ee)return;if(typeof window>"u")try{const n=typeof import.meta<"u"&&import.meta.url?import.meta.url:"";let e,r;if(n){const{createRequire:p}=await _(async()=>{const{createRequire:w}=await import("./_virtual_module-BaOu_2_5.js");return{createRequire:w}},[]),h=p(n);e=h("fs"),r=h("path")}else typeof require<"u"?(e=require("fs"),r=require("path")):(e=await _(()=>import("./index-CTrQ0wEq.js").then(p=>p.y),__vite__mapDeps([0,1])),r=await _(()=>import("./index-CTrQ0wEq.js").then(p=>p.x),__vite__mapDeps([0,1])));const m=r.join("/","src","share","prompts"),M=p=>{try{const h=r.join(m,p);if(e.existsSync(h))return e.readFileSync(h,"utf8")}catch{}return""};N=M("system_prompt.md"),E=M("character.md"),S=M("lore.md");const v=T.YUIHIME_SYSTEM_ROOT||T.YUIHIME_ROOT||"~/.yuihime",Y=r.isAbsolute(v)?v:r.join("/",v),d=T.YUIHIME_AGENT_PATH||r.join(Y,"agent"),A=(p,h)=>{try{const w=r.join(d,p);if(e.existsSync(w))return e.readFileSync(w,"utf8")}catch(w){console.warn(`[PromptManager] Failed loading ${p}, using fallback`,w)}return h};c.register("core:system_prompt",A("system_prompt.md",N),!0),c.register("core:character",A("character.md",E),!0),c.register("core:lore",A("lore.md",S),!0),c.register("core:character_name",F(A("character.md",E)),!0)}catch(n){console.warn("[PromptManager] Server-side file sync failed:",n),c.register("core:system_prompt",N),c.register("core:character",E),c.register("core:lore",S),c.register("core:character_name",F(E))}else{try{E=(await _(async()=>{const{default:n}=await import("./character-D5U7B9i8.js");return{default:n}},[])).default,S=(await _(async()=>{const{default:n}=await import("./lore-DdLaZ87e.js");return{default:n}},[])).default,N=(await _(async()=>{const{default:n}=await import("./system_prompt-sv6r-i5A.js");return{default:n}},[])).default}catch(n){console.warn("[PromptManager] Browser dynamic raw imports failed:",n)}try{const n=await fetch("/api/system/markdown/system_prompt.md");if(n.ok){const m=await n.json();m&&m.content&&m.content.trim().length>0&&(N=m.content)}const e=await fetch("/api/system/markdown/character.md");if(e.ok){const m=await e.json();m&&m.content&&m.content.trim().length>0&&(E=m.content)}const r=await fetch("/api/system/markdown/lore.md");if(r.ok){const m=await r.json();m&&m.content&&m.content.trim().length>0&&(S=m.content)}}catch(n){console.warn("[PromptManager] Browser failed to fetch dynamic agent overrides:",n)}c.register("core:system_prompt",N),c.register("core:character",E),c.register("core:lore",S),c.register("core:character_name",F(E))}try{const n=await R.getModularSettings(),e=n==null?void 0:n.characterName;e&&e.trim()&&c.register("core:character_name",e.trim(),!0)}catch{}const f=`
...
\${toolMeta}
`.trim();c.register("prompt-manager:available_tools",f),Ee=!0}const Be={metadata:{id:"prompt-manager",name:"yui-cognition: Prompt Manager",description:"Consolidates system prompt, character lore, and context into a unified LLM instruction.",version:"1.2.0",type:Ye.CORTEX,phase:"PHASE 2: COMPRESSION",order:5,configSchema:{fields:{systemPrompt:{type:"textarea",label:"System Prompt Override",default:N,description:"Base instruction for the AI behavior."},characterLore:{type:"textarea",label:"Character Lore",default:E,description:"Personality and backstory."},worldLore:{type:"textarea",label:"World Knowledge",default:S,description:"Facts and world context."},dialogueContextSize:{type:"slider",label:"Conversation History Window",default:40,min:10,max:100,description:"Number of latest conversation memory records fed into the LLM neural core."},llmSizePreset:{type:"select",label:"LLM Multi-Tier Parameter Optimization Preset",default:"standard",options:[{value:"standard",label:"Standard - Full Cognitive Metacognition (High Param LLMs: >14B)"},{value:"medium",label:"Medium - Balanced CoT Flow (Medium Param LLMs: 7B - 14B)"},{value:"lite",label:"Lite - Compressed Context Window (Small Param LLMs: 2B - 4B)"},{value:"tiny",label:"Tiny - Direct Response & Ultra-Short Prompting (Tiny LLMs: <1.5B)"}],description:"Optimizes cognitive circuit parameters, conversation history size, prompt layout, JSON schema, and core data sent to the LLM based on parameter size to reduce latency and prevent cognitive timeouts."}}}},run:async(f,n,e)=>{var Z,ee,te,ae,ie,re,oe,ne,se,le,ce,me,de,ue,pe,he,fe,ye;console.log("[PROMPT_MANAGER] Assembling final instruction set with realistic growth metrics..."),await je();let r={};try{r=await R.getModularSettings()||{}}catch{}const m=e.moduleConfig||(r==null?void 0:r["prompt-manager"])||{},M=m.systemPrompt||c.get("core:system_prompt"),v=m.characterLore||c.get("core:character"),Y=m.worldLore||c.get("core:lore"),d=c.get("core:character_name")||F(v),A=(M||"").replace(/\$\{characterName\}/g,d);c.register("core:system_prompt",A,!0),c.register("core:character",v,!0),c.register("core:lore",Y,!0),c.register("core:character_name",d,!0);let p=[],h=[],w=[],K=[],W=[];try{p=e.memories||await R.getMemories()||[]}catch{}try{h=e.allIdentities||await R.getIdentities()||[]}catch{}try{w=e.dreams||await R.getDreams()||[]}catch{}try{K=e.heuristics||await R.getStrategies()||[]}catch{}try{W=await R.getCapabilities()||[]}catch{}const X=p.length>0?[...p].sort((t,a)=>t.timestamp-a.timestamp)[0]:null,we=X?X.timestamp:Date.now()-1e3*60*60*24*3.5,ve=Math.max(.1,Number(((Date.now()-we)/(1e3*60*60*24)).toFixed(1))),Oe=p.length,J=p.filter(t=>t.speaker&&t.speaker!=="agent"&&t.speaker!=="System"&&t.speaker!=="subconscious").length,Re=p.filter(t=>t.speaker==="agent").length,H=["Web Console UI"];((Z=r==null?void 0:r["telegram-bridge"])!=null&&Z.botToken||(ee=r==null?void 0:r["telegram-bridge"])!=null&&ee.enableTelegram)&&H.push("Telegram Bridge Platform"),((te=r==null?void 0:r["discord-bridge"])!=null&&te.token||(ae=r==null?void 0:r["discord-bridge"])!=null&&ae.enableDiscord)&&H.push("Discord Guild Server"),((ie=r==null?void 0:r["twitch-bridge"])!=null&&ie.oauthToken||(re=r==null?void 0:r["twitch-bridge"])!=null&&re.enableTwitch)&&H.push("Twitch Streaming Chat");const Se=((oe=n.relation)==null?void 0:oe.trust)||50,Ne=((ne=n.relation)==null?void 0:ne.affection)||50,Ae=W.filter(t=>t.enabled).length;let C=[];if(typeof window>"u")try{const t=typeof import.meta<"u"&&import.meta.url?import.meta.url:"";let a,i;if(t){const{createRequire:o}=await _(async()=>{const{createRequire:s}=await import("./_virtual_module-BaOu_2_5.js");return{createRequire:s}},[]),u=o(t);a=u("fs"),i=u("path")}else typeof require<"u"?(a=require("fs"),i=require("path")):(a=await _(()=>import("./index-CTrQ0wEq.js").then(o=>o.y),__vite__mapDeps([0,1])),i=await _(()=>import("./index-CTrQ0wEq.js").then(o=>o.x),__vite__mapDeps([0,1])));const l=i.resolve("/","src","core","available_tools.json");if(a.existsSync(l)){const o=a.readFileSync(l,"utf8");C=JSON.parse(o).map(u=>({metadata:u}))}}catch(t){console.warn("[PromptManager] Failed loading available_tools.json:",t)}(!C||C.length===0)&&(C=D.getTools());let L="";if(C.length>0)if(Array.isArray(e.tools)&&e.tools.length>0)L='Native tool calling is active. Tool schemas are provided via the standard API tools array. Use the standard `tool_calls` JSON format with `id`, `type: "function"`, and `function: { name, arguments }` structure.\n';else for(const a of C)L+=`- **${a.metadata.id}**: ${a.metadata.description}
`,a.metadata.parameters&&(L+=`  - Parameter Schema: \`\`\`json
${JSON.stringify(a.metadata.parameters,null,2)}
\`\`\`
`);else L="No external system tools are currently available.";const Ce=c.compile("prompt-manager:available_tools",{toolsList:L,toolSyntax:c.compile("tools:syntax_openai",{}),toolPagination:c.compile("tools:syntax_pagination",{}),toolOutput:c.compile("tools:output_format",{}),toolMeta:c.compile("tools:_meta",{})}),$e=D.getCortexModules(),be=D.getProviders(),Me=D.getTTSModules(),Le=D.getGateways();$e.map(t=>{var a,i,l,o;return`- **${((a=t.metadata)==null?void 0:a.id)||"unknown"}** (${((i=t.metadata)==null?void 0:i.name)||"Unnamed Module"} - Phase: ${((l=t.metadata)==null?void 0:l.phase)||"Unknown"}): ${((o=t.metadata)==null?void 0:o.description)||"No description"}`}).join(`
`),be.map(t=>{var a,i,l,o,u;return`- **${((a=t.metadata)==null?void 0:a.id)||"unknown"}** (${((i=t.metadata)==null?void 0:i.name)||"Unnamed Provider"} - Models: ${((o=(l=t.metadata)==null?void 0:l.models)==null?void 0:o.join(", "))||"Auto"}): ${((u=t.metadata)==null?void 0:u.description)||"No description"}`}).join(`
`),Me.map(t=>{var a,i,l;return`- **${((a=t.metadata)==null?void 0:a.id)||"unknown"}** (${((i=t.metadata)==null?void 0:i.name)||"Unnamed TTS"}): ${((l=t.metadata)==null?void 0:l.description)||"No description"}`}).join(`
`),Le.map(t=>{var a,i,l;return`- **${((a=t.metadata)==null?void 0:a.id)||t.id||"unknown"}** (${((i=t.metadata)==null?void 0:i.name)||t.name||"Unnamed Gateway"}): ${((l=t.metadata)==null?void 0:l.description)||t.description||"No description"}`}).join(`
`);const P=e.activePersona;let B="";P&&P.systemPrompt&&(B=`
# ACTIVE COGNITIVE FOCUS (${P.name||P.id})
${P.systemPrompt}
`);const I=m.llmSizePreset||"standard";let O=Number(m.dialogueContextSize||40);I==="tiny"?O=Math.min(8,O):I==="lite"?O=Math.min(15,O):I==="medium"&&(O=Math.min(30,O));const Q=p.filter(t=>t&&t.content&&t.content.trim().length>0&&(t.speaker||t.type==="dialogue"||t.type==="interaction")).sort((t,a)=>(t.timestamp||0)-(a.timestamp||0)).slice(-O),Pe=Q.length>0?Q.map(t=>{var i;let a=t.speaker||t.type;return a==="agent"?a=d:(a==="user"||!a||a==="chat"||a==="interaction")&&(a=e.userName&&e.userName!=="chat"&&e.userName!=="anon"?e.userName:((i=e.viewerIdentity)==null?void 0:i.perceivedName)||"user"),`${a}: ${t.content}`}).join(`
`):"No previous conversation records yet.";let V="",$=[];if(I==="tiny"?$=[{name:"IDENTITY.md",title:`WHO AM I (${d.toUpperCase()}'S IDENTITY)`,maxChar:500},{name:"USER.md",title:"WHO YOU ARE HELPING (HUMAN RELATIONSHIP DETAIL)",maxChar:500}]:I==="lite"?$=[{name:"IDENTITY.md",title:`WHO AM I (${d.toUpperCase()}'S IDENTITY)`,maxChar:1200},{name:"SOUL.md",title:`WHO YOU ARE (${d.toUpperCase()}'S SOUL & CHARACTER VALUE)`,maxChar:1e3},{name:"USER.md",title:"WHO YOU ARE HELPING (HUMAN RELATIONSHIP DETAIL)",maxChar:1e3}]:I==="medium"?$=[{name:"IDENTITY.md",title:`WHO AM I (${d.toUpperCase()}'S IDENTITY)`,maxChar:2500},{name:"SOUL.md",title:`WHO YOU ARE (${d.toUpperCase()}'S SOUL & CHARACTER VALUE)`,maxChar:2e3},{name:"MEMORY.md",title:"LONG-TERM MEMORY (CURATED EXPERIENCE & PREFERENCES)",maxChar:1500},{name:"USER.md",title:"WHO YOU ARE HELPING (HUMAN RELATIONSHIP DETAIL)",maxChar:1500}]:$=[{name:"IDENTITY.md",title:`WHO AM I (${d.toUpperCase()}'S IDENTITY)`},{name:"SOUL.md",title:`WHO YOU ARE (${d.toUpperCase()}'S SOUL & CHARACTER VALUE)`},{name:"MEMORY.md",title:"LONG-TERM MEMORY (CURATED EXPERIENCE & PREFERENCES)"},{name:"USER.md",title:"WHO YOU ARE HELPING (HUMAN RELATIONSHIP DETAIL)"},{name:"TOOLS.md",title:"LOCAL ENVIRONMENT NOTES & TOOL USAGE SPECIFICS"},{name:"HEARTBEAT.md",title:"PERIODIC FOCUSES & BACKGROUND TASKS"}],typeof window>"u")try{const t=typeof import.meta<"u"&&import.meta.url?import.meta.url:"";let a,i;if(t){const{createRequire:s}=await _(async()=>{const{createRequire:g}=await import("./_virtual_module-BaOu_2_5.js");return{createRequire:g}},[]),y=s(t);a=y("fs"),i=y("path")}else typeof require<"u"?(a=require("fs"),i=require("path")):(a=await _(()=>import("./index-CTrQ0wEq.js").then(s=>s.y),__vite__mapDeps([0,1])),i=await _(()=>import("./index-CTrQ0wEq.js").then(s=>s.x),__vite__mapDeps([0,1])));const l=T.YUIHIME_SYSTEM_ROOT||T.YUIHIME_ROOT||"~/.yuihime",o=i.isAbsolute(l)?l:i.join("/",l),u=T.YUIHIME_AGENT_PATH||i.join(o,"agent");for(const s of $){let y=i.join(u,s.name);if(a.existsSync(y)||(y=i.join("/",s.name)),a.existsSync(y),a.existsSync(y)){let g=a.readFileSync(y,"utf8").trim();s.maxChar&&g.length>s.maxChar&&(g=g.substring(0,s.maxChar)+`
...[Content truncated for tiny/lite model optimization Presets]...
`),g.length>0&&(V+=`
# ${s.title} (${s.name})
${g}
`)}}}catch(t){console.warn("[PROMPT_MANAGER] Dynamic markdown injections error:",t)}else try{const t=$.map(async i=>{try{const l=await fetch(`/api/system/markdown/${i.name}`);if(l.ok){const o=await l.json();if(o&&o.content&&o.content.trim().length>0){let u=o.content.trim();return i.maxChar&&u.length>i.maxChar&&(u=u.substring(0,i.maxChar)+`
...[Content truncated for tiny/lite model optimization Presets]...
`),`
# ${i.title} (${i.name})
${u}
`}}}catch(l){console.warn(`[PROMPT_MANAGER] Failed to fetch client-side markdown for ${i.name}:`,l)}return""});V=(await Promise.all(t)).join("")}catch(t){console.warn("[PROMPT_MANAGER] Dynamic client-side markdown injections error:",t)}let q="",G="";if(h&&h.length>0){if(q=h.map(t=>{const a=Array.isArray(t.linkedAccounts)?t.linkedAccounts:[];return`- **${t.perceivedName}** (Linked accounts: ${a.join(", ")||"none"})`}).join(`
...
- **System ID**: ${((le=e.viewerIdentity)==null?void 0:le.id)||"new_id"}
- **Perceived Name**: ${((ce=e.viewerIdentity)==null?void 0:ce.perceivedName)||e.userName||"user"}
...
${Ce}
    ...
    `.trim();return{...e,assembledSystemPrompt:De}}};export{Be as PromptManagerModule};
