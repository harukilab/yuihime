import{l as r}from"./logger-CA3ARVhv.js";import{SettingsManager as l}from"./settings-CnJgBnb6.js";class a{constructor(){this.templates=new Map}static getInstance(){return a.instance||(a.instance=new a,a.instance.registerDefaultCortexPrompts()),a.instance}getActivePreset(){try{const e=l.getInstance().get("prompt-manager");return(e==null?void 0:e.llmSizePreset)||"standard"}catch{return"standard"}}registerDefaultCortexPrompts(){this.register("cortex:planning",`
\${planning_directive}
User Request: "\${input}"
