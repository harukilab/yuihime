              ...
              if (staticProvider.tab === 'chat') {
                if (staticProvider.id === 'official_chat') {
                  ...
                  fields = {
                    apiKey: { 
                      type: 'textarea', 
                      label: 'Gemini API Key Pool (bisa isi banyak, pisah baris)', 
                      description: 'Satu baris = satu API Key. Disarankan gunakan minimal 2 key agar pool rotasi aktif.',
                      default: '' 
                    },
                    model: { type: 'multiselect', label: 'Model Pool', default: [], dynamicOptions: true }
                  };
                }
