...
/**
 * Looped reflection modules for the AGI_REFLECT cortex phase (Area 2).
 *
...
export const MetacognitionReflectModule: CortexModule = {
  metadata: {
    ...
    description: 'Per-iteration meta-cognitive self-critique executed inside the ReAct loop (AGI_REFLECT phase).',
    version: '1.0.0',
...
export const SelfAwarenessReflectModule: CortexModule = {
  metadata: {
    ...
    description: 'Per-iteration self-awareness mirroring executed inside the ReAct loop (AGI_REFLECT phase).',
    version: '2.1.0',
    type: ModuleType.CORTEX,
    order: 11,
    phase: 'AGI_REFLECT',
