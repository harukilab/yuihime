...
export const ModularSettings: React.FC<ModularSettingsProps> = ({ 
  ...
  const settingsMenu = [
    ...
    { id: 'scenes', title: 'Scenes', desc: 'Customize the live stage virtual background environments.', status: true, icon: Palette },
    { id: 'models', title: 'Models', desc: 'Select Live2D, VRM or custom avatars.', status: true, icon: Monitor },
    { id: 'memory', title: 'Memory', desc: 'Manage episodic memory and cognitive knowledge bases.', status: true, icon: Brain },
    ...
    { id: 'matrix', title: 'Matrix', desc: 'Live emotional state and neural lattice metrics.', status: true, icon: Cpu },
    { id: 'plan', title: 'Planner', desc: 'Create priority trees and autonomous task planners.', status: true, icon: Clock },
    { id: 'file-automation', title: 'Automation', desc: 'Define AI rules for sandboxed workspace file actions.', status: true, icon: Sliders },
    { id: 'data', title: 'Data Control', desc: 'Purge chat histories, memories or reset systems.', status: true, icon: Database },
    ...
    { id: 'system', title: 'Stage Config', desc: 'Optimize displays, subtitles and active overlay schemes.', status: true, icon: Settings2 },
    { id: 'env', title: 'Environment', desc: 'Manage secure system environment credentials (.env).', status: true, icon: Code },
